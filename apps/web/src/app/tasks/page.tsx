...
const BASE_COLUMNS: Array<{ id: Exclude<TaskStatus, "archived">; label: string; color: string }> = [
  ...
  { id: "blocked", label: "Blocked", color: "from-rose-500/20 to-rose-500/0" },
  { id: "done", label: "Done", color: "from-emerald-500/20 to-emerald-500/0" },
];

const ARCHIVED_COLUMN: { id: "archived"; label: string; color: string } = {
  id: "archived",
  label: "Archived",
  color: "from-zinc-700/25 to-zinc-700/0",
};
...
export default function TasksPage() {
  ...
  }, [tasks, showArchived, searchQuery, priorityFilter, tagFilter]);

  const columns = showArchived ? [...BASE_COLUMNS, ARCHIVED_COLUMN] : BASE_COLUMNS;
      ...
      <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-wrap items-end justify-between gap-5">
            <div>
              ...
              <p className="mt-2 text-sm text-zinc-400">
                Inbox-to-done pipeline with drag-and-drop status movement and full task operations.
              </p>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="hidden items-center gap-3 rounded-xl border border-white/10 bg-white/[0.03] px-3 py-2 sm:flex">
                ...
                <span className="text-zinc-700">|</span>
                <span className="text-xs uppercase tracking-wider text-zinc-500">Blocked</span>
                <span className="font-mono text-sm text-rose-300">{stats.blocked}</span>
                <span className="text-zinc-700">|</span>
        ...
        <section className="mb-6 flex flex-wrap items-center gap-4">
          <input
            ...
            className="min-w-[220px] flex-1 rounded-xl border border-white/10 bg-black/30 px-4 py-2 text-sm text-zinc-200 placeholder-zinc-500 focus:border-cyan-400/40 focus:outline-none"
          />
          <select
