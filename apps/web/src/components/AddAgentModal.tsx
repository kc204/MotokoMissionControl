...
export default function AddAgentModal({
    ...
    try {
      const agentId = await createAgent({
        ...
        models: {
          ...
          execution: thinkingModel,
          heartbeat: thinkingModel,
          fallback: thinkingModel,
        },
      });
      ...
      setCharacter("");
      setLore("");
      setThinkingModel("kimi-coding/kimi-for-coding");
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-2xl border border-white/15 bg-[linear-gradient(180deg,rgba(10,16,26,0.98),rgba(7,11,18,0.98))] p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block">
              ...
              >
                ...
                <option value="INT">INT - Intermediate</option>
